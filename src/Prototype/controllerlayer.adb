...
package body ControllerLayer is
   ...
   function SetPossibleToActivate( inoutAllData : in out VisualLayer.AllData ) return VisualLayer.AllData is
   ...
   begin
      ...
      begin
         task_GT.Get_Turn( aTurn );
         Put_Line("task_GT.Get_Turn( aTurn ); #2d time \/");
         task_GT.Get_Turn( aTurn );
         Put_Line("task_GT.Get_Turn( aTurn ); /\");
   ...
   function DeSetPossibleToAtivate( inoutAllData : in out VisualLayer.AllData ) return VisualLayer.AllData is
      row : Integer;
      aTmpFigurePosition : ModelLayer.Position;
   begin
      task_Gt.Get_Turn( aTurn );
   ...
   begin
      ...
      Put_Line("ShowPossibleMoves; \/");
      ShowPossibleMoves;
      Put_Line("ShowPossibleMoves; /\");
      Put_Line("aAllData.aMainWindow.aWindow.Show_All;\/");
      aAllData.aMainWindow.aWindow.Show_All;
      Put_Line("aAllData.aMainWindow.aWindow.Show_All;/\");
   end Activate_Button;
   ...
   procedure Activate_Button_Call( Object : access Gtk.Widget.Gtk_Widget_Record'Class; aPosition : in ModelLayer.Position ) is
      ...
      aLocalTurn : GameTurn.Turn := GameTurn.Player;
   begin
      delay( 0.5 );
      Put_Line("Activate_Button_Call \/");
      Activate_Button( aPosition );
      
      
      Put_Line("task_GT.Get_Turn( aLocalTurn ); \/");
      task_GT.Get_Turn( aLocalTurn );
      Put_Line("task_GT.Get_Turn( aLocalTurn ); /\");
   ...
   begin
      ...
      --        Put_Line("#1 Move_Figure_Call => [" & aToPosition.aYPosition'Img & "," & aToPosition.aXPosition'Img & "]");
      aAllData := DeSetPossibleToAtivate( aAllData );
      task_GT.End_Turn( aTurn );
      aAllData := SetPossibleToActivate( aAllData );
